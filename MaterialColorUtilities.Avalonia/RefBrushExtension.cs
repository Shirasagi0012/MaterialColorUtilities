...
public class RefBrushExtension
{
    public RefBrushExtension()
    {
    }

    public RefBrushExtension(RefPaletteToken palette, byte tone)
    {
        Palette = palette;
        Tone = tone;
    }
    ...
    {
        return MaterialColorRuntime.ProvideBrush(serviceProvider,
            (scheme, theme) => scheme.Resolve(Palette, Tone, theme));
    }
}
